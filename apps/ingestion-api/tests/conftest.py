...
#
# MONGODB_URL must be set for Settings() to validate,
...
os.environ.setdefault("MONGODB_DATABASE", "c2pa_tests")
...
def credentials_present() -> bool:
    ...
    File layout: ``<repo>/apps/ingestion-api/tests/conftest.py`` -> repo root
    is three folders up."""
